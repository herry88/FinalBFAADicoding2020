    ...
    override fun getItem(position: Int): Fragment {
        ...
        when(position){
            0 -> {
                ...
                val bundle_1 = Bundle()
                bundle_1.putString("passData", passDataUsername)
                fragment.arguments = bundle_1
                log.d("Ini Data Follower", fragment.arguments.toString())
            }
            1 -> {
                fragment = FollowingFragment()
                val bundle_2 = Bundle()
                bundle_2.putString("passData", passDataUsername)
                log.d("Ini Data Following", fragment.arguments.toString())
            }
        }
